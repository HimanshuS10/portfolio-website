...
export const Features = () => {
  return <section className="py-20 md:py-24">
    <div className="container">
      <h2 className="text-5xl md:text-6xl font-medium tracking-tighter text-center">Elevate your SEO effeorts.</h2>
      <p className="text-white/70 text-lg md:text-xl md:max-w-2xl mx-auto tracking-tight text-center">From small satrtup to large compaines ew adsf jasdf jhasd fjasdf as dfiasd fiasdf asdf</p>
      <div className="mt-10 flex flex-col lg:flex-row gap-3">
        {tabs.map(tab => (
          <div key={tab.title} className="border border-white/15 flex p-2.5 rounded-xl gap-2.5 items-center lg:flex-1">
            ...
            {tab.isNew && <div className="text-xs rounded-full px-2 py-0.5 bg-[#8c44ff] font-semibold">new</div>}
          </div>
        ))}
      </div>
