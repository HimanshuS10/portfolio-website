...
export const Hero = () => {
  ...
  return <motion.section ref={sectionRef} className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative bg-black text-white/70"
    style={{
  ...
  >
    ...
    <motion.div style={{
      ...
      duration: 100,
      ease: 'linear',
    }} className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] rounded-full border-[3.5px] border-white/20 border-dotted top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></motion.div>
